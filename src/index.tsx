...
export { ExpandedGoodCard, ExpandedGoodCardFooter, ExpandedGoodCardHeader } from "./common/ExpadedGoodCard/ExpandedGoodCard";
export { GoodCard, GoodCardFooter, GoodCardHeader } from "./common/GoodCard/GoodCard";
...
export { DesktopLanguages } from "./desktop/DesktopLanguages/DesktopLanguages";
