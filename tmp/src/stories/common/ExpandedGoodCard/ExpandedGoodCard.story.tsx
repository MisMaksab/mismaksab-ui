...
export const ExpadnedGoodCardStory = (props: any) => {
    const {layout, imageURL, discount, retailer, price, oldPrice, title, pricePerKilo, expireDateStr, unitType, goToRetailerText, goToRetailerLink, discountConditionsText} = props;
